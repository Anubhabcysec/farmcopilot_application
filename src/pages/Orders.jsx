              ...
              >
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    <span style={{
                      fontSize: '10px', fontWeight: 700, color: '#15803d', textTransform: 'uppercase',
                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(0,0,0,0.08)', paddingBottom: '12px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <span style={{ fontFamily: 'monospace', fontSize: '13px', fontWeight: 700, color: '#15803d' }}>
                        {order.id}
                      </span>
                  ...
                  {delivery && order.status === 'ready' && (
                    <div style={{
                      ...
                      <div>
                        <div style={{ fontSize: '11px', fontWeight: 700, color: '#1d4ed8', letterSpacing: '0.5px', marginBottom: '4px' }}>
                          📦 DELIVERY DETAILS
                        </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: deliveryForm.paymentMode === opt.value
                          ? 'rgba(16,185,129,0.1)'
                          : 'rgba(0,0,0,0.03)',
                        color: deliveryForm.paymentMode === opt.value ? '#15803d' : '#6b7280',
                        transition: 'all 0.2s',
                      }}
                    >
                      {opt.label}
          ...
          <div className="instruction-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedInstruction.dosage && (
              <div className="instruction-step-box">
                ...
                <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#1f2937', fontWeight: 600 }}>
                  {selectedInstruction.dosage}
                </p>
              </div>
            )}
            ...
            <div className="instruction-step-box">
              ...
              <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#374151', lineHeight: 1.5 }}>
            ...
            {selectedInstruction.precautions && (
              <div className="instruction-step-box" style={{ borderLeftColor: '#f59e0b' }}>
                <span className="instruction-step-num" style={{ color: '#b45309' }}>SAFETY & PRECAUTIONS</span>
                <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#374151', lineHeight: 1.5 }}>
                  {selectedInstruction.precautions}
                </p>
              </div>
